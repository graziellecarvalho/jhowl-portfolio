...
export const AboutMeSection = (): JSX.Element => {
  return (
    <section id="about" className="w-full max-w-[1053px] mx-auto py-8 relative">
          ...
          <div className="relative w-full h-[404px]">
            ...
            <Card className="absolute w-[309px] h-[309px] top-[77px] left-[38px] bg-[#000002] rounded-3xl border border-solid border-[#979797] overflow-hidden p-0">
              <img
                ...
                alt="Jhonatan Souza profile"
                src="/rectangle-31.png"
              />
            </Card>

            {/* Decorative dots */}
            <div className="absolute top-[29px] left-3 font-['Inconsolata',Helvetica] font-bold text-white text-3xl tracking-[0] leading-[normal]">
              . . . .<br />. . . .<br />. . . .
            </div>
          </div>
        </div>
      ...
      <div className="mt-8 flex items-start gap-3">
        {/* Decorative elements */}
        <div className="relative w-[86px] h-[85px] flex-shrink-0">
